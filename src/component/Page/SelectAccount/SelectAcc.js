...
const SelectAcc = () => {
  ...
  const handleAccountChange = (event) => {
    ...
    const selectedAccount = account.find((acc) => acc.AccID === selectedAccountId);
    if (selectedAccount) {
      // Update the broker and cash balance display based on the selected account
      document.getElementById('SelectedBroker').textContent = selectedAccount.BrokerID;
      document.getElementById('SelectedCashBalance').textContent = selectedAccount.CashBalance;
    } else {
    ...
    <div className='AllsectionSelectAcc'>
      <div className='boxSelectAcc'>
        <div className='Head-Text-SelectAcc'>
          Welcome to <br />TradeKub
        </div>
        <div className='TextUsernameSelectAcc'>
          UsernameFromLogin
        </div>
        <div className='TextBoxSelectAcc'>
          <div className='SelectAccDropDownBox'>
            <select id="SelectAccDropDown" className="SelectAccDropDown" onChange={handleAccountChange}>
          ...
          <div className='SelectBrokerIDandCash_Box'>
            ...
            <div className='SelectBrokerIDandCash_Data' id="SelectedBroker"></div>
          </div>
          <div className='SelectBrokerIDandCash_Box'>
            <div className='SelectBrokerIDandCash_Text'>Cash Balance</div>
            <div className='SelectBrokerIDandCash_Data' id="SelectedCashBalance"></div>
          </div>
        </div>
